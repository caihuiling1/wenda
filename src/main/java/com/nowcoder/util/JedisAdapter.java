...
public class JedisAdapter implements InitializingBean{
    ...
    public static void main(String[] argv){
        ...
        jedis.setex("hello2", 30, "world");     //带有过期时间， 可用于验证码
        ...
        print(9, jedis.linsert(listName, BinaryClient.LIST_POSITION.BEFORE, "a4", "xx1"));
        print(10, jedis.lrange(listName, 0, jedis.llen(listName)));

        //hash
        String userKey = "userxx";
        jedis.hset(userKey, "name","jim");
        jedis.hset(userKey, "age", "23");
        jedis.hset(userKey, "phone", "1234567789");
        ...
        jedis.hsetnx(userKey, "school", "zju");//不存在就设置进去，存在就无效
        ...
        print(25, jedis.sismember(likeKey1, "23"));
